...
var core = module.exports = {
   ...
   * * low-level for call tao bao api
	...
	call: function (httpArgs, args, callback) {
		...
		// var app_secret = args.app_secret
	...
	signArgs: function (args) {
		...
		return helper.crypt(c, args.sign_method, args.app_secret).toUpperCase()
	},
	...
	generateApi: function (apiArr, defaultNamespace) {
		...
		var upperRep = function (all, letter) {
			return letter.toUpperCase()
		}

		_.each(apiArr, function (apiObj) {
			var method; var defaultArg = {}; var namespace = defaultNamespace || 'taobao'
